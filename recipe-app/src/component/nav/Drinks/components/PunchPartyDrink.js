...
function PunchPartyDrink(props) {
  ...
  const [idDrink, setIdDrink] = useState()
    ...
    const getDrinkByName = async (name) => {
      ...
      useEffect(() => {
        if (!single){
        getDrinkByName('Punch%20/%20Party%20Drink')
     ...
     {(!single)?( 
        <section className="theCocktailSection">
          ...
          return (
              <div className="productContainerC" onClick={() => {
                  ...
                  <img src={alchol.strDrinkThumb}  alt="Punch/Party Drink" />
                  <h3 className="nameC" >
                      {alchol.strDrink}
                  </h3>
              </div>
      ...
      <div className="productContainerC" onClick={() => {
        handleclick()
          ...
          <section className="theCocktailSection"> 
           <img src={singleDrink[0].strDrinkThumb}  alt="Punch/Party Drink" />
        <h3 className="nameC" >
  ...
  export default PunchPartyDrink;